    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            if (str.toLowerCase().equals("a")){
                ...
                int duration = duration_hour + duration_min;
...
/*                while (true){
                ...
                list = addMovie(list, title, year, firstName, lastName, genre, duration_hour, duration_min, country, about);
                System.out.println();
    ...
    public static Movie[] addMovie(Movie[] list, String title, int year, String firstName, String lastName, String genre, int duration_hour, int duration_min, String country, /*cast*/ String about){

        Movie m = new Movie(title, year, new Director(firstName, lastName), Movie.Genre.fromString(genre),  country, about);
